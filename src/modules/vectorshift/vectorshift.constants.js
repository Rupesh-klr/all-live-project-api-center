...
// LLM model registry shown in the Models tab.
const DEMO_MODELS = [
  {
    id: 'claude-opus-4-8', name: 'Claude Opus 4.8', provider: 'Anthropic',
    contextWindow: 200000, maxOutput: 32000, avgLatencyMs: 2100, tier: 'enterprise', status: 'active',
    strengths: ['Long-context', 'Code review', 'Reasoning', 'Analysis'],
    note: 'Best for production RAG pipelines requiring deep reasoning over long documents.',
  },
  {
    id: 'claude-fable-5',  name: 'Claude Fable 5',  provider: 'Anthropic',
    contextWindow: 500000, maxOutput: 64000, avgLatencyMs: 1800, tier: 'enterprise', status: 'active',
    strengths: ['Multimodal', 'Creative', 'Speed', 'Extended context'],
    note: 'Largest context window available — ideal for whole-codebase or multi-document retrieval.',
  },
  {
    id: 'gpt-4o',          name: 'GPT-4o',           provider: 'OpenAI',
    contextWindow: 128000, maxOutput: 16000, avgLatencyMs: 1600, tier: 'standard',  status: 'active',
    strengths: ['Coding', 'Function calling', 'Multimodal'],
    note: 'Strong function-calling support — preferred for tool-use heavy pipelines.',
  },
  {
    id: 'mistral-large',   name: 'Mistral Large',    provider: 'Mistral',
    contextWindow: 128000, maxOutput: 8192,  avgLatencyMs: 900,  tier: 'standard',  status: 'active',
    strengths: ['Speed', 'Cost efficiency', 'Multilingual'],
    note: 'Lowest latency option; best for high-throughput, cost-sensitive retrieval loops.',
  },
]
...
module.exports = {
  ...
  PYTHON_SERVICE_URL, PUBLIC_ENDPOINTS,
}
